...
import { Box, Button, MenuItem, TextField, Select, FormControl, InputLabel, SelectChangeEvent } from '@mui/material';
import useStore from '../store';

const SearchFilters = () => {
  const { searchFilters, setSearchFilters, clearSearchFilters, toggleSearchTriggered } = useStore();
  ...
  return (
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', mb: 2 }}>
      ...
      />
      <FormControl variant="outlined" sx={{ width: '200px' }}> {/* Set the same width for Category */}
      ...
      <FormControl variant="outlined" sx={{ width: '200px' }}> {/* Set the same width for Availability */}
